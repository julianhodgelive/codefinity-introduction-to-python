...
for products_sold in range(len(products)):
    products[products_sold][1] -= units_sold[products_sold][1]

for add in range(len(products)):
    products[add][1] += shipment_received[add][1]
